    ...
    init() {
        ...
        setInterval(function() {
            ...
            if (notify_content) {
                ...
                var countstr = document.querySelector('#webpushtip1 > div > div.notify_type > label > em').innerHTML
                var accountstr = document.querySelector('#webpushtip1 > div > div.notify_content > p.notify_account').innerHTML
...
ipcRenderer.on('click_notify_main', function(e,arg) {
    console.log('click_preload.js')
    document.querySelector('.newmailNotify').click()
})
ipcRenderer.on('timeout_notify_main', function(e, arg) {
